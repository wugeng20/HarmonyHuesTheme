    ...
    <div class="footer-left">
      <div class="footer-copyright py-2">
        <div>© <?php echo generateCopyright($this->options->sitedate); ?> Designed by <a
            ...
            target="_blank"><?php $this->options->title()?></a> &Iota; <a href="/sitemap.xml"
            title="<?php $this->options->title()?>站点地图" target="_blank">站点地图</a> &Iota; <a
...
<div class="main-search">
  <div class="site-search d-flex justify-content-center">
    <div class="search-box card no-animation p-3">
