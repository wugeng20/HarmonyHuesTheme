          ...
          <?php else: ?>
            <ul class="row comment-form-info">
              <li class="col-12 col-md-4 col-xl-4 mb-2">
                <label for="author" class="d-flex align-items-center comment-form-info-label">
                  <i class="iconfont icon-yonghunicheng"></i>
                  <input type="text" name="author" id="author" class="form-control" placeholder="昵称"
                    value="<?php $this->remember('author'); ?>" required />
                </label>
              </li>
              <li class="col-12 col-md-4 col-xl-4 mb-2">
                <label for="mail" class="d-flex align-items-center comment-form-info-label">
              ...
              <li class="col-12 col-md-4 col-xl-4 mb-2">
                <label for="url" class="d-flex align-items-center comment-form-info-label">
