...
<header id="navbar" class="navbar p-2<?php echo $this->options->navStyle == 'mini' ? ' nav-ui-two' : ' nav-ui-one'; ?>">
  <div class="container navbar-box p-1 p-md-2">
        ...
        <li class="nav-item">
          ...
          <div class="sub-menu">
            <ul>
              ...
              <li class="<?php echo $this->is('category', $child['slug']) ? ' active' : ''; ?>">
    ...
    <div class="navbar-icon">
      ...
      <div class="back-to-top flex-column align-items-center justify-content-center" style="display: none;">
      ...
      <div id="menu-line" title="手机菜单栏"><i class="iconfont icon-caidan"></i></div>
    </div>
  </div>
</header>