...
echo '<form class="harmonyhues-backup" action="?'.$name.'bf" method="post">
        <input class="m-2" type="submit" name="type" value="备份模板" />
        <input class="m-2" type="submit" name="type" value="还原备份" />
        <input class="m-2" type="submit" name="type" value="删除备份" />
      </form>';
?>